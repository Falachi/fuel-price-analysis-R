...
```{r save-models-regression, include=FALSE}
...
``` {r classification-result-setup, include=FALSE}
library(dplyr)
library(ggplot2)
library(tidyr)
library(knitr)
...
```{r classification-result-load-libraries, message=FALSE, warning=FALSE}
# Load libraries
library(dplyr)
library(ggplot2)
library(tidyr)
...
```{r classification-result-load-models, message=FALSE, warning=FALSE}
...
#### XGBoost predictions
```{r xgboost-predictions, message=FALSE, warning=FALSE}
...
```{r logistic-predictions, message=FALSE, warning=FALSE}
...
```{r core-metrics, message=FALSE, warning=FALSE}
print(comparison_df)
```
...
```{r computational-latency, message=FALSE, warning=FALSE}
print(speed_df)
```
#### Interpretation:
...
```{r advanced-diagnostics, message=FALSE, warning=FALSE}
