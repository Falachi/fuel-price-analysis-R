...
# Install packages (Uncomment if running for the first time in your console)
...
df <- read_csv("fuel_prices_cleaned_final.csv")
```
...
```{r}
# Extracting datasets 
write_csv(q1_monthly_data, "Q1_Monthly_Regression_Data.csv")
write_csv(q2_quarterly_data, "Q2_Quarterly_Classification_Data.csv")
